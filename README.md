...
**To do**
  ...
  * edoc to markdown 
  * edoc transclude 
  * quote/context semantics 
  * warn flat package module unsafe 
  * rebar.config to auto refresh deps and compile 
  * echo - stand-alone 
  * echo - under nosh 
  * nosh_bin README.md 
  * $PATH search 
  * revise loops to use fully-qualified function calls 
  * doc update: "procedural" should read "imperative" 
  * doc update: first character, lower case: atom; upper case: variable 
  * nosh_parse: tokenizing 
  * implement nosh_exec 
  * implement nosh_eval to convert nosh_parse output to nosh_exec input 
  * finish up nosh_parse 
  * nosh as application 
  * standardize nosh_exec behaviour 
  * nosh as nosh_command 
  * Buffered I/O (pending get_char working in noterm) 
  * File System: pwd / cd 
  * File System: *NIX / cygwin / Win32 
  * File System: NoSQL 
  * Env 
  * Sh commands 
  * Erl commands 
  * Couch commands 
  * Add support for line continuation (currently throws error) 
...
_Generated by EDoc, Apr 27 2012, 19:43:02._
